...
export const metadata: Metadata = {
  title: "Privacy Policy — MortgagePaymentEstimator",
  description: "Privacy policy for MortgagePaymentEstimator.",
};
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 prose-article">
      ...
      <p>MortgagePaymentEstimator does not collect personal information. We use Google Analytics to understand aggregate traffic patterns and Google AdSense to serve advertisements. These third-party services may use cookies.</p>
      <h2>Cookies</h2>
      ...
      <h2>Contact</h2>
      <p>For privacy questions, contact us at: info@mortgagepaymentestimator.net</p>
    </div>
  );
}
